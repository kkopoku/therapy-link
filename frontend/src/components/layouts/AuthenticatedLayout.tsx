...
const AuthenticatedLayout: React.FC<LayoutProps> = ({children, pageName, navFunctionName, navFunction}) => {
    return(
        <div>
            <main className="flex flex-row min-h-screen items-center bg-white w-full font-sans text-black transition-all">
                <div className="flex items-center w-fit">
                    <SideBar />
                </div>
                <div className="flex flex-col flex-grow h-screen pb-3 px-16 w-full items-center">
