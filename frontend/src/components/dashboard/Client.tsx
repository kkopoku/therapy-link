...
export const ClientDashboard:React.FC<ClientDashboardProps> = ({records, loading}) => {
                    ...
                    <div className="flex flex-col text-xs items-center"> 
                        <div className="grid grid-cols-3 w-full gap-6">
                            <div className="flex flex-col col-span-1 w-full h-24 bg-green-100 rounded-3xl border-dashed border border-secondaryGreen p-3">
                                <p>Credits Left:</p>
                                <div className="flex items-center text-4xl h-full font-bold text-primaryGreen">
                                    <p>{`${records.user.credits}`}</p>
                                </div>
                            </div>
                            <div className="flex flex-col col-span-1 w-full h-24 bg-slate-100 rounded-3xl border-dashed border border-secondaryGreen p-3">
